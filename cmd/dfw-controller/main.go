...
import (
	...
	"github.com/hwchiu/mon/internal/controller"
	"github.com/hwchiu/mon/pkg/distribution"
	"github.com/hwchiu/mon/pkg/frontend"
)
...
func init() {
	...
	utilruntime.Must(dfwv1alpha1.AddToScheme(scheme))
}
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		WebhookServer: webhook.NewServer(webhook.Options{
			Port: 9444, // separate from our custom gRPC on 9443
		}),
		HealthProbeBindAddress: probeAddr,
		LeaderElection:         enableLeaderElection,
		LeaderElectionID:       "dfw-controller.hwchiu.github.io",
	})
	if err != nil {
	...
	go func() {
		if err := frontend.StartFrontendServer(":8082", mgr.GetClient(), distServer); err != nil {
			setupLog.Error(err, "frontend server failed")
		}
	}()
